        ...
        <div className={styles.case_study_overview_content__JppPK}>
          <div>
            ...
            <p>
              ...
              business models, they’ve paved the way for others to reimagine
              their practices with sustainability in mind.
            </p>
            <p>
              For Patagonia’s flagship experience, we were tasked with crafting
              a design solution that brought its massive product and content
              library to life in a simple yet insightful way. For a brand that
              truly lives it’s values, it was vital that the user experience
              echo that—meaning that our challenge was to create a digital
              shopping experience that tells a brand story at every touchpoint.
            </p>
            <h5>Approach</h5>
            <p>
            ...
            <p>
              ...
              by the brand’s mission. Most importantly, it serves both function
              and storytelling by not only selling clothes, but transforming
              value systems.
            </p>
