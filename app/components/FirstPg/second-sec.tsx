import styles from "@/Stylesheets/Firstpgstyles/second-sec.module.css";
import buttonstyles from "@/Stylesheets/button.module.css";

export default function Second_sec() {
  return (
    <section
      className={styles.home_overview_container__fy0XZ}
      // style={{
      //   visibility: "visible",
      //   transform: "matrix(1, 0, 0, 1, 0, -874)",
      // }}
    >
      <figure className={styles.home_overview_line__ArfHR}></figure>
      <div className={styles.home_overview_row__l0Bhh}>
        <div className={styles.home_overview_body__eA4g_}>
          <h3>
            <p>
          ...
          <p className={styles.home_overview_button__oYkOk}>
            <a
        ...
        <figure className={styles.home_overview_logo__JiFZL}>
